...
# DEVELOPER BY YOUSSEF BOUBLI VERSION 0.1V :)
# DONT FORGET SUBS IN MY CHANNEL " Youssef Boubli"
...
class Client(tk.Frame):
    ...
    def createWidgets(self):
        ...
        self.chatBox= tk.Text(self.chatFrame, height=10, bg='#2980b9', font=('arial',16))
        ...
        userLabel= tk.Label(self.usersFrame,text='User list :', font=('arial',16)).grid(column=0,row=0 ,sticky = tk.N+tk.S+tk.E+tk.W)
        self.userList=tk.Listbox(self.usersFrame,bg='#c0392b',font=('arial',16), fg="#FFF")
        ...
        self.messageBox= tk.Text(self,height=3, bg='#2980b9', fg='#FFF' ,insertwidth=4, font=('arial',16,'bold'))
    ...
    def send(self,event):
        ...
        if len(msg)==0:
            ...
            messagebox.showinfo(title='Error.', message='Message cannot be empty.')
        else:
